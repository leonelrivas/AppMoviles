 ...
 <html>
  ...
  <body>
    ...
    <header class="bar bar-nav">
      <h1 class="title">Ecomputer Categoria</h1>
    </header>
    ...
    <div class="content">
        <h5>Te puede interesar: </h5>
           ...
           <div class="bar bar-standard bar-header-secondary">
               <a href="#" onclick="ira(<?php echo $r["idcategoria"]; ?>)"><button class="btn btn-block"><?php echo $r['categoria']; ?></button></a>
           </div>
          <?php
                }
              }
    ...
    <nav class="bar bar-tab">
      <a class="tab-item" href="../ecomputer/index.php">
